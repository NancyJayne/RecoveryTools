...
- [x] Open bundled Product-variant links as closable shop-card bubbles in both the live Marketplace detail page and Product-creator preview. Show the exact variant image, retail/sale/approved-Affiliate pricing, and short description first; selecting the bubble then opens the exact Product variant detail URL, while the admin version uses a new tab to protect unsaved editing work.
