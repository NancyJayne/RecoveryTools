...
- [x] Replace the mismatched Connections-step form previews with one interactive entity-relationship diagram. Keep the current Item, Blueprint, Plan, or Campaign in the centre with its active entity variants; show exact Product stock, template-enabled Item stock, bundle components, main-entity Assets, manufacturing Blueprints, Workshop operations, purchase unlocks, future Library selections, and reusable Item/Plan links as connected data-model records. Reuse the Product and Asset drawers, move the existing authoritative entity-stock controls into an Item-stock drawer without changing their fields or persistence, and edit exact Product stock through its Product-variant fulfilment section.
