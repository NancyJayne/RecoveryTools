...
- [ ] Complete nested Create and attach workflows for missing Items and Blueprints, matching the existing promotion-Asset child flow. Save or autosave the parent Product draft first, then return staff to the exact Product variant and connection section without losing edits.
