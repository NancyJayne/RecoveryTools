...
- [x] Arrange the Connections ERD by ownership: keep entity stock and main-entity Assets directly under the central entity; present Product and the future Library as separate outward-facing destinations; nest Product stock, manufacturing Blueprints, purchase unlocks, and bundle components under Product; and show the instructor-only Workshop-operations Blueprint connection only when the current entity type is Workshop. Use teal for direct entity records, blue for outward Product/Library records, and amber for reusable or Workshop delivery relationships.
