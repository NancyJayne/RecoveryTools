...
- [x] Arrange the Connections ERD by ownership: keep entity stock, main-entity Assets, and future Library selections directly under the central entity; nest Product stock, manufacturing Blueprints, purchase unlocks, and bundle components under Product; and connect instructor-only Workshop operations to the Workshop/participant-material side. Use teal for direct entity records, blue for Product-owned records, and amber for Workshop delivery relationships.
