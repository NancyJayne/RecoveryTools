...
- [x] Add persistent diagram-view switches for Product and Library so either outward branch can be hidden and restored without deleting or changing its saved relationship. Import direct relationship headings from linked Item/Blueprint/Plan fields in the selected entity-variant templates, with the generic linked-record row retained for legacy/fallback relationships.
