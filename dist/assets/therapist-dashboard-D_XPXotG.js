function e(){const s=document.getElementById("therapistDashboardSection");s&&(s.classList.remove("hidden"),s.innerHTML=`
  ...
  `,s.scrollIntoView({behavior:"smooth"}))}export{e as initTherapistDashboard};
